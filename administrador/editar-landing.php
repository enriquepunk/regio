									...
									<div class="widget-sec">
										<form class="sec" role="form" name="guardar" id="validar_form" method="post" action="lib/actualizar-internas.php" enctype="multipart/form-data">
                              			...
                              			<hr>
                               			...
                               			<a style="float:right;" id="bsliders">
                                			...
                                			<div id="seccion1">   
                              				<div class="form-group">
                                   			...
                                   			<div class="form-group">
													...
													<textarea id="contenidoseccion1" name="contenidoseccion1" class="form-control" rows="7"><?php echo $row_cas['int_contenido_barra_1']; ?></textarea>
						 						</div>
                                   			<div class="form-group">
                               			...
                               			<div id="seccion3">   
                              				<div class="form-group">
                                   			...
                                   			<div class="form-group">
													...
													<textarea id="contenidoseccion3" name="contenidoseccion3" class="form-control" rows="7"><?php echo $row_cas['int_contenido_barra_3']; ?></textarea>
						 						</div>
                                   			<div class="form-group">
													<label for="exampleInputEmail1"  style="font-weight:100;">Imagen 1 (560 x 426 px):</label>
                              			...
                              			<div id="seccion5">   
                              				<div class="form-group">
                                   			...
                                   			<div class="form-group">
													...
													<textarea id="contenidoseccion5" name="contenidoseccion5" class="form-control" rows="7"><?php echo $row_cas['int_contenido_barra_5']; ?></textarea>
						 						</div>
                                   			<div class="form-group">
													<label for="exampleInputEmail1" style="font-weight:100;">Imagen 1 (560 x 426 px):</label>
                                			...
                                			<div id="seccion6">   
                              				<div class="form-group">
                                   			...
                                   			<div class="form-group">
													...
													<textarea id="contenidoseccion6" name="contenidoseccion6" class="form-control" rows="7"><?php echo $row_cas['int_contenido_barra_6']; ?></textarea>
						 						</div>
                                   			<div class="form-group">
													<label for="exampleInputEmail1"  style="font-weight:100;">Imagen 1 (560 x 426 px):</label>
                                			...
                                			<div id="seccion7">   
                              				<div class="form-group">
                                   			...
                                   			<div class="form-group">
													...
													<textarea id="contenidoseccion7" name="contenidoseccion7" class="form-control" rows="7"><?php echo $row_cas['int_contenido_barra_7']; ?></textarea>
						 						</div>
                                   			<div class="form-group">
													<label for="exampleInputEmail1"  style="font-weight:100;">Imagen 1 (560 x 426 px):</label>
                                			...
                                			<div id="seccion8">   
                              				<div class="form-group">
                                   			...
                                   			<div class="form-group">
													...
													<textarea id="contenidoseccion8" name="contenidoseccion8" class="form-control" rows="7"><?php echo $row_cas['int_contenido_barra_8']; ?></textarea>
						 						</div>
                                   			<div class="form-group">
													<label for="exampleInputEmail1" style="font-weight:100;">Imagen 1 (560 x 426 px):</label>
