							...
							<div class="col-md-12">
								<div class="widget-body">
									<div class="widget-heading blue">
										<i class="icon-table pull-left"></i><h3 class="pull-left">Listado de Landings</h3>
									</div>
									<div class="widget-sec">
										<div class="streaming-table">
                                      	...
                                      	<?php 
						  						$sql=mysql_query("
													SELECT * FROM internas where int_landing=1 ORDER BY int_id ASC",$conexion);
														...
														$x=1; 
                                                			...
                                                			echo '<td>'.strtoupper($row['int_titulo']).'</td>'; 
																...
																echo '<td align="center" valign="top">
											 	  					  	<a href="editar-landing.php?id='.$row['int_id'].'"><i class="icon-share-sign" style="font-size:18px"></i></a>
																      </td>';
																echo ' </tr>';
																$x++;
															}
