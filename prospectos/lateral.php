<?php	
	...
	$para  = 'prospectos@hdsconsultoria.com'. ', ';
	...
	/*$conexion=mysql_connect("localhost","vacacion_hugo","cocacola22");
...
<div style="padding: 10px; width: 150px; text-align: center; margin-right: auto; margin-left: auto; margin-top: 200px;">
    ...
    <img src="loanding.gif" />
</div>
<meta http-equiv="Refresh" content="5;url=http://www.gruporegio.mx/gracias.php">