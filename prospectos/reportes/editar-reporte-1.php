				...
				<div class="col-md-12">
					<div class="widget-body">
						...
						<div class="widget-sec">
							<div class="widget-sec">
								<form class="sec" role="form" name="guardar" id="validar_form" method="post" action="lib/actualizar_reporte_1.php" enctype="multipart/form-data">
                                <input type="hidden" id="id" name="id" value="<?php echo $usu_id; ?>">
                                <div class="form-group">
										<label for="exampleInputEmail1">Bancos:</label>
										<textarea class="form-control" rows="7" id="bancos" name="bancos" ><?php echo $row_cas['sem_bancos']; ?></textarea>
						 			</div>
                                	<div class="form-group">
										<label for="exampleInputEmail1">Ingresos:</label>
										<textarea class="form-control" rows="7" id="ingresos" name="ingresos" ><?php echo $row_cas['sem_ingresos']; ?></textarea>
						 			</div>
                                	<div class="form-group">
										<label for="exampleInputEmail1">Egresos:</label>
										<textarea class="form-control" rows="7" id="egresos" name="egresos" ><?php echo $row_cas['sem_egresos']; ?></textarea>
						 			</div>
                                	<div class="form-group">
										<label for="exampleInputEmail1">Impuestos:</label>
										<textarea class="form-control" rows="7" id="impuestos" name="impuestos" ><?php echo $row_cas['sem_impuestos']; ?></textarea>
						 			</div>
                               	<div class="form-group">
										<label for="exampleInputEmail1">Otros:</label>
										<textarea class="form-control" rows="7" id="otros" name="otros" ><?php echo $row_cas['sem_otros']; ?></textarea>
						 			</div>
                                	<div class="form-group">
										<label for="exampleInputEmail1">Próxima Semana:</label>
										<textarea class="form-control" rows="7" id="proyeccion" name="proyeccion" ><?php echo $row_cas['sem_proyeccion']; ?></textarea>
						 			</div>
