...
//  Definiciones
	...
	$db_server			= "localhost"; 
	$db_name			= "accesoca_sistema"; 
	$db_username		= "accesoca_hugo"; 
...
<BODY 
	...
	alink="#000020">
	<center>
<h1>Respaldo de base de datos</h1></center><br>
...
<?php
		...
		echo( "<br>&copy;2012 <a href=\"mailto:contacto@accesocancun.com\">Acceso Cancún</a><br>" );
...
<BODY 
	...
	vlink="#000020" 
	alink="#000020">
	<center><h1>Respaldo de base de datos</h1>
</center><br>
	<strong><center><p>Usuario/contraseña equivocado. Acceso denegado.</p></center>
<?php
			echo( "</strong><br><br><hr><center><small>" );
