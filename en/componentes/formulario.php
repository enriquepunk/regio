<div class="login_form">     
	...
	$(function() 
     ...
     <select style="padding-top:0px !important; padding-bottom:0px !important; height:40px !important; width:100% !important; background:#FFF; color:#000; border: 1px solid #ccc !important; font-family: 'Lato',helvetica,arial,sans-serif !important; font-size:14px;" onChange="pagoOnChange(this)">
 	<option value="">Subject</option>
    <option value="Administración / Contabilidad">Accounting</option>
    <option value="Almacenaje, Logística y Distribucón">Fulfillment</option>
    <option value="Compras">Sales</option> 
    <option value="Cotizaciones">Estimations / Quotations</option>
    <option value="Creatividad">Creativity</option> 
    <option value="Mercadotecnía">Marketing</option>
    <option value="Servicio al Cliente">Customer Service</option>
</select> 
<div id="camposcotiza">
&nbsp;<b style="font-weight:bold;">Our Products:</b><br> 
...
<span style="font-size:11px; font-weight:normal !important;">(Seleccione uno o varios dando click)</span>
   	...
   	<div id="validacion">
		<input maxlength="4" name="codigo" id="codigo" type="text" style="float: left; border: 1px solid rgb(204, 204, 204); color: rgb(58, 58, 58); font-family: 'Lato',helvetica,arial,sans-serif !important; height: 20px; font-size: 14px; padding-left: 10px; width: 80px; background: none repeat scroll 0px 0px rgb(255, 255, 255);" value="Code" onFocus="if (this.value == 'Code') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'Code';}"/>
