<?php	
	...
	$conexion=mysql_connect("localhost","bd_web","imprent@15");
	mysql_select_db("bd_web",$conexion); 
...
<div style="padding: 10px; width: 150px; text-align: center; margin-right: auto; margin-left: auto; margin-top: 200px;">
    ...
    <img src="http://www.gruporegio.mx/images/loanding.gif" />
</div>
<meta http-equiv="Refresh" content="3;url=http://www.gruporegio.mx/gracias.php">
