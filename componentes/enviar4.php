<?php	
	...
	$edad = $_POST['edad4'];	
	$ciudad = $_POST['ciudad4'];	
	$estado = $_POST['estado4'];
	$pais = $_POST['pais4'];	
	$telefono = $_POST['telefono4'];
	$celular = $_POST['celular4'];
	...
	{
		$carpeta = '/public_html/componentes/cv';
		$archivo_file = basename($_FILES["imagen"]["name"]);
		$archivo_ext = substr($archivo_file, strrpos($archivo_file, ".") + 1);
		$archivo_file = str_replace('.'.$archivo_ext, '', $archivo_file);
		$archivo_file = $archivo_file.rand(5, 15);
		$archivo = $archivo_file.'.'.$archivo_ext;
		$archivo_tmp = $_FILES["imagen"]["tmp_name"];

	if(move_uploaded_file($archivo_tmp, $carpeta.$archivo))
	{	
	      						...
	      						<table border="0" width="600" cellpadding="0" cellspacing="0" class="container" bgcolor="#ffffff">
        							<tr>
                                      	...
                                      	<ul>
												...
												<li><b>Edad:</b> '.htmlentities($edad).'<br></li>
												<li><b>Ciudad:</b> '.htmlentities($ciudad).'<br></li>
												<li><b>Estado:</b> '.htmlentities($estado).'<br></li>
												<li><b>Pais:</b> '.htmlentities($pais).'<br></li>
												<li><b>Telefono:</b> '.htmlentities($telefono).'<br></li>
			  									<li><b>Celular:</b> '.htmlentities($celular).'<br></li>
												<li><b>Correo:</b> '.htmlentities($correo).'<br></li>
												<li><b>Area:</b> '.htmlentities($area).'<br></li>
												<li><b>Curriculum Vitae:</b> <a href="http://gruporegio.com.mx/componentes/cv/'.$archivo.'" target="_blank">Descargar CV</a><br></li>
            								</ul>
            								<br>
                                       	<p style="font-size: 12px; color: #000;" align="right">&copy; 2015. Derechos Reservados <a href="http://www.hdsconsultoria.com" style="color:#000; font-weight:bold;" target="_blank"> HDS Consultor&iacute;a</a>.</p>
          									<br>
           							</td>
                               	</tr>
                               	<tr>
